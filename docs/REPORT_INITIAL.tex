...
%
    ...
    \begin{center}
        \includegraphics[width=5.5in]{Graphs/Plays_SongLength.png}
    \end{center}
    ...
    length.
%    To elaborate, given that songs that 200 to 300 seconds long are very
%    common as opposed to the outliers that are 60 or 600 seconds long, there\s more
%    songs in that range to play. With more songs to play, popularity of individual
%    songs doesn\t necessarily line up with this scatter plots clear bell shape.
%    The bell shape shows that the most played songs are within the 200 to 300 second
%    range and, assuming the distribution of song lengths isn\’t
%    inversely proportional to this bell shape, this allow implies, most likely with
%    some accuracy, that the most played individual songs are within the 200 to 300
%    second range.

    \begin{center}
        \includegraphics[width=5.5in]{Graphs/AvgSongLen_ArtistAlbums.png}
    \end{center}
    ...
    \begin{center}
        \includegraphics[width=5.5in]{Graphs/AvgAlbumSongLen_by_NumSongs.png}
    \end{center}
